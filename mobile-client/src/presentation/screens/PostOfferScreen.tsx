...
export default function PostOfferScreen() {
  ...
  const route = useRoute<RouteProp<PostStackParamList, "PostOffer">>();
  ...
  if (!isAuthenticated) {
    return (
      <SafeAreaView style={styles.container}>
        <CreateAccessGate
          title="Sign in to post an offer"
          description="Only authenticated members can create new offers."
        />
      </SafeAreaView>
    );
  }
  ...
  return (
    <SafeAreaView style={styles.container} edges={["top"]}>
      <View style={styles.topBar}>
        ...
        <Text style={styles.topBarTitle}>{serviceId ? "Edit Offer" : "Create Offer"}</Text>
        <View style={styles.backBtn} />
      </View>
      <ServiceWizard type="Offer" serviceId={serviceId} />
    </SafeAreaView>
  );
}
