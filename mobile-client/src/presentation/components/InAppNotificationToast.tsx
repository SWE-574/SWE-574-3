      ...
      navigateToNotificationTarget(
        {
          ...
          related_service_type: (current.payload.related_service_type as 'Offer' | 'Need' | 'Event') ?? null,
          related_report: current.payload.related_report ?? null,
          related_user: current.payload.related_user ?? null,
          created_at: '',
        },
        navigation,
      );
